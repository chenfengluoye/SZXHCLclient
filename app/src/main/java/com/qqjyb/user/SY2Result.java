...
public class SY2Result extends AppCompatActivity {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            if(code==1){
                ...
                try {
                    ...
                    readapter=new SY3ReAdapter(syrearray,"sy2scores");
                    relistView.setAdapter(readapter);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }else {
                Toast.makeText(SY2Result.this,"网络错误",Toast.LENGTH_SHORT).show();
            }
        }
    };
    @Override
    ...
    public void reflash(){
        ...
        Net.connect(Net.host+"/szxhcl/getsy2data",jsonObject.toString(),handler);
    }
